...
([English and other languages](https://ikotas-github-io.translate.goog/25fpsIVTCGuide/?_x_tr_sl=ja&_x_tr_tl=en&_x_tr_hl=en)) ~by Google Translate~
...
avsファイルを読み込み可能な任意のエンコードアプリケーションでエンコードを実施してください。
  * エンコードする際のTDecimateの設定は以下です。
    ...
    * 本設定で出力すると、厳密には`25fps(25/1)`ではなく、`25.0001255026381fps(4980000/199199)`で出力されます。  
...
* 2024.11.28 v2.0
  ...
  * 後工程に"`AssumeFPS(25,1)`"を追加 (357,366-368、375-390)
  * 「5. Cycle内の～」に新たに方法1.を追加(後続の番号は繰り上げ) (386-401)
